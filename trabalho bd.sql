...
CREATE TABLE IF NOT EXISTS `mydb`.`instrutor` (
  ...
  INDEX `fk_table2_pessoa_idx` (`pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`escoteiro` (
  ...
  `nivel` INT NOT NULL,
  `pessoa_cpf` VARCHAR(45) NOT NULL,
  INDEX `fk_escoteiro_pessoa1_idx` (`pessoa_cpf` ASC) VISIBLE,
  PRIMARY KEY (`pessoa_cpf`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`administrador` (
  ...
  INDEX `fk_administrador_pessoa1_idx` (`pessoa_cpf` ASC) VISIBLE,
  PRIMARY KEY (`pessoa_cpf`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`escoteiro_has_doencaCronica` (
  ...
  INDEX `fk_escoteiro_has_doencaCronica_doencaCronica1_idx` (`doencaCronica_id` ASC) VISIBLE,
  INDEX `fk_escoteiro_has_doencaCronica_escoteiro1_idx` (`escoteiro_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Evento` (
  ...
  INDEX `fk_Evento_administrador1_idx` (`administrador_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`atividade` (
  ...
  INDEX `fk_atividade_tipoAtividade1_idx` (`tipoAtividade_idtipoAtividade` ASC) VISIBLE,
  INDEX `fk_atividade_Evento1_idx` (`Evento_idEvento` ASC) VISIBLE,
  INDEX `fk_atividade_local1_idx` (`local_idlocal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`instrutor_administra_atividade` (
  ...
  INDEX `fk_instrutor_has_atividade_atividade1_idx` (`atividade_idatividade` ASC) VISIBLE,
  INDEX `fk_instrutor_has_atividade_instrutor1_idx` (`instrutor_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`escoteiro_participa_atividade` (
  ...
  INDEX `fk_escoteiro_has_atividade_atividade1_idx` (`atividade_idatividade` ASC) VISIBLE,
  INDEX `fk_escoteiro_has_atividade_escoteiro1_idx` (`escoteiro_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`compra` (
  ...
  INDEX `fk_compra_administrador1_idx` (`administrador_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`equipamento` (
  ...
  INDEX `fk_equipamento_tipoEq1_idx` (`tipoEq_idtipoEq` ASC) VISIBLE,
  INDEX `fk_equipamento_compra1_idx` (`compra_idcompra` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`atividade_has_equipamento` (
  ...
  INDEX `fk_atividade_has_equipamento_equipamento1_idx` (`equipamento_idequipamento` ASC) VISIBLE,
  INDEX `fk_atividade_has_equipamento_atividade1_idx` (`atividade_idatividade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`administrador_descarta_equipamento` (
  ...
  INDEX `fk_administrador_has_equipamento_equipamento1_idx` (`equipamento_idequipamento` ASC) VISIBLE,
  INDEX `fk_administrador_has_equipamento_administrador1_idx` (`administrador_pessoa_cpf` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`compra_has_tipoEq` (
  ...
  INDEX `fk_compra_has_tipoEq_tipoEq1_idx` (`tipoEq_idtipoEq` ASC) VISIBLE,
  INDEX `fk_compra_has_tipoEq_compra1_idx` (`compra_idcompra` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`telefone_has_pessoa` (
  ...
  INDEX `fk_telefone_has_pessoa_pessoa1_idx` (`pessoa_cpf` ASC) VISIBLE,
  INDEX `fk_telefone_has_pessoa_telefone1_idx` (`telefone_numero` ASC) VISIBLE,
